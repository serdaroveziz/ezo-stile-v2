...
export const DICTIONARY = {
  tr: {
    ...
    changePhone: 'Telefon Numarası Değiştir',
    inAppNotifs: 'Uygulama İçi Bildirimler',
    soundNotifs: 'Sesli Bildirimler',
    newBookingNotifs: 'Yeni Randevu Bildirimleri',
    statusUpdateNotifs: 'Randevu Onay / Durum Güncellemesi',
    cancelReqNotifs: 'İptal Talebi Bildirimleri',
    reschedReqNotifs: 'Tarih/Saat Değişiklik Talebi',
    upcomingReminderNotifs: 'Yaklaşan Randevu Hatırlatması',
    noShowNotifs: 'No-show Bildirimi',
    completedNotifs: 'Tamamlanan Randevu Bildirimi',
    staffInviteNotifs: 'Personel Daveti Bildirimleri',
    staffRoleNotifs: 'Personel Rol / Yetki Değişikliği',
    packagePremiumNotifs: 'Paket / Premium Bildirimleri',
    billingNotifs: 'Ödeme / Abonelik Bildirimleri',
    campaignNotifs: 'EZO STİLE Kampanya & Duyurular',
    searchPlaceholder: 'Salon adı, şehir, ilçe veya hizmet ara...',
    salonGallery: 'Fotoğraf Galerisi',
    ...
    completedCount: 'Tamamlanan İşlem',
    customerCount: 'Müşteri Sayısı',
    avgTransaction: 'Ortalama İşlem Tutarı',
    cancelCount: 'İptal',
    noShowCount: 'No-show',
    weeklyTotal: 'Haftalık Toplam',
    dailyAverage: 'Günlük Ortalama',
    busiestDay: 'En Yoğun Gün',
    topService: 'En Çok Satılan Hizmet',
    monthlyTotal: 'Aylık Toplam',
    topEarnerService: 'En Çok Kazandıran Hizmet',
    topEarnerStaff: 'En Çok Kazandıran Çalışan',
    historicalLocked: '🔒 2 Yıllık Ciro Geçmişi — Premium',
    backBtn: '← Geri',
    arrived: '✅ Geldi',
    notArrived: '🚫 Gelmedi'
  },
  en: {
    ...
    topEarnerService: 'Top Revenue Service',
    topEarnerStaff: 'Top Revenue Staff',
    historicalLocked: '🔒 2-Year Revenue History — Premium',
    backBtn: '← Back',
    arrived: '✅ Arrived',
    notArrived: '🚫 No-Show'
  },
  ru: {
    ...
    completedCount: 'Завершенные заказы',
    customerCount: 'Клиенты',
    avgTransaction: 'Средний чек',
    cancelCount: 'Отмены',
    noShowCount: 'Неявки',
    weeklyTotal: 'Итого за неделю',
    dailyAverage: 'Среднедневное',
    busiestDay: 'Загруженный день',
    topService: 'Популярная услуга',
    monthlyTotal: 'Итого за месяц',
    topEarnerService: 'Прибыльная услуга',
    topEarnerStaff: 'Прибыльный мастер',
    historicalLocked: '🔒 2 года истории — Premium',
    backBtn: '← Назад',
    arrived: '✅ Пришел',
  ...
  ar: {
    ...
    completedCount: 'المعاملات المكتملة',
    customerCount: 'عدد العملاء',
    avgTransaction: 'متوسط قيمة المعاملة',
    cancelCount: 'الإلغاءات',
    noShowCount: 'عدم الحضور',
    weeklyTotal: 'إجمالي الأسبوع',
    dailyAverage: 'المتوسط اليومي',
    busiestDay: 'أكثر الأيام ازدحاماً',
    topService: 'الخدمة الأكثر مبيعاً',
    monthlyTotal: 'إجمالي الشهر',
    topEarnerService: 'الخدمة الأكثر إيراداً',
    topEarnerStaff: 'الموظف الأكثر إيراداً',
    historicalLocked: '🔒 سجل سنتين — Premium',
    backBtn: '← عودة',
    arrived: '✅ حضر',
    notArrived: '🚫 لم يحضر'
  },
  tk: {
    ...
    todayBookings: '📅 Bugünki Ýazylmalar',
    pendingRequests: '⏳ Garaşylýan Yüzlenmeler',
    completedBookings: '✅ Tamamlananlar',
    todayRevenue: '💰 Bugünki Girdeji',
    day: 'Gün',
    week: 'Hepde',
    month: 'Aý',
    history: 'Taryhy',
    totalRevenue: 'Jemi Girdeji',
    completedCount: 'Tamamlanan Amallar',
    customerCount: 'Müşderi Sany',
    avgTransaction: 'Ortalaça Tutar',
    cancelCount: 'Ýatyrmalar',
    noShowCount: 'Gelmedikler',
    weeklyTotal: 'Hepdelik Jemi',
    dailyAverage: 'Günlik Ortalaça',
    busiestDay: 'Iň Güýçli Gün',
    topService: 'Iň Köp Satylan Hyzmat',
    monthlyTotal: 'Aýlyk Jemi',
    topEarnerService: 'Iň Ýokary Girdejili Hyzmat',
    topEarnerStaff: 'Iň Ýokary Girdejili Işgär',
    historicalLocked: '🔒 2 Ýyllyk Taryh — Premium',
    backBtn: '← Yza',
    arrived: '✅ Geldi',
    notArrived: '🚫 Gelmedi'
  }
